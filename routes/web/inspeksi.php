...
Route::prefix('inspeksi')->middleware(['auth', 'inspeksi'])->group(function () {
  ...
  Route::get('/karyawan/cetak-sp', [KaryawanController::class, 'cetak']);

  Route::get('/karyawan/data', [KaryawanController::class, 'getData']);

  Route::get('/karyawan/karyawan-non-borong', [KaryawanController::class, 'nonBorong']);
  ...
  Route::post('/absensi-karyawan/import', [AbsensiController::class, 'import']);
  Route::post('/absensi-karyawan/import-non-borong', [AbsensiController::class, 'importNonBorong']);
